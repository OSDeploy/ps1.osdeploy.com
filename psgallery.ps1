<#
.SYNOPSIS
    WinPE PSGallery PSCloudScript at psgallery.ps1.osdeploy.com
.DESCRIPTION
    WinPE PSGallery PSCloudScript at psgallery.ps1.osdeploy.com
.NOTES
    Requires WinPE 10 with ADK PowerShell Package
.LINK
    https://github.com/OSDeploy/ps1.osdeploy.com/blob/main/psgallery.ps1
.EXAMPLE
...
Write-Verbose 'Starting a new PowerShell process' -Verbose
